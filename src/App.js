...
import LOGO from '../src/logoK.svg'
		...
		<div className='app-container'>
			<header className='header'>
				<div className='header-content'>
					<Link className='linkLogo' to='/kazoku-staff'>
						<img src={LOGO} alt='KAZOKU' className='logo-image' />
					</Link>
				</div>
			</header>
	...
	return (
		<footer className='footer'>
			<div className='social-links'>
				...
				<a
					href='https://vk.com/kazoku.asianguide'
					target='_blank'
					rel='noopener noreferrer'
					className='social-link'
				>
...
const CategoryPage = () => {
	...
	if (!category) return <Navigate to='/kazoku-staff' />
		...
		<Layout>
			<div className='station-page' style={{ padding: '0 10px' }}>
				...
				<div className='navigation-buttons'>
					...
					<Link to='/kazoku-staff' className='nav-button home-button'>
						<FiHome />
					</Link>
				</div>
			</div>
...
const App = () => {
	return (
		<Router>
			<Routes>
				<Route path='/kazoku-staff' element={<HomePage />} />
				<Route path='/category/:categoryId' element={<CategoryPage />} />
				<Route path='/station/:stationId' element={<StationPage />} />
				<Route path='/dish/:dishId' element={<DishPage />} />
				<Route path='*' element={<Navigate to='/kazoku-staff' />} />
			</Routes>
		</Router>
	)
}
